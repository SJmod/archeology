...
import net.mcreator.archeology.procedures.BoneOnDirtControllerUpdateTickProcedure;
...
public class BoneOnDirtControllerBlock extends ArcheologyModElements.ModElement {
	@ObjectHolder("archeology:bone_on_dirt_controller")
	public static final Block block = null;
	public BoneOnDirtControllerBlock(ArcheologyModElements instance) {
		super(instance, 5);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("bone_on_dirt_controller");
		}
		...
		public void onBlockAdded(BlockState blockstate, World world, BlockPos pos, BlockState oldState, boolean moving) {
			...
			int z = pos.getZ();
			{
				...
				BoneOnDirtControllerUpdateTickProcedure.executeProcedure($_dependencies);
			}
		}
